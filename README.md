# <div align='center'>baileys-mod - WhatsApp Web API with Call Media Streaming</div>

<div align='center'>

Modified by **hansaka@alexainc** · [Alexainc/baileys-mod](https://github.com/Alexainc/baileys-mod)

Adds native WhatsApp **call answering + audio/video streaming** (pytgcalls/ntgcalls-style). See **[CALLS.md](CALLS.md)**.

</div>

<div align="center">

<h3>@alexainc/baileys-mod</h3>

<br/>

<!-- Badges -->
<p>
  <img src="https://img.shields.io/npm/dw/%40alexainc%2Fbaileys-mod?label=npm&color=%23CB3837" alt="NPM Downloads"/>
  <img src="https://img.shields.io/github/v/release/Alexainc/baileys-mod?include_prereleases&sort=semver" alt="Latest Release"/>
  <img src="https://img.shields.io/github/languages/code-size/Alexainc/baileys-mod" alt="Code Size"/>
  <img src="https://img.shields.io/github/license/Alexainc/baileys-mod" alt="License"/>
  <img src="https://img.shields.io/github/stars/Alexainc/baileys-mod" alt="Stars"/>
  <img src="https://img.shields.io/github/forks/Alexainc/baileys-mod" alt="Forks"/>
</p>

<!-- GitHub Stats -->
<p>
  <img src="https://github-readme-stats.vercel.app/api?username=Alexainc&show_icons=true&theme=radical" alt="GitHub Stats"/>
</p>
...
```
yarn add @alexainc/baileys-mod
```

Use the edge version (no guarantee of stability, but latest fixes + features)
```
yarn add github:Alexainc/baileys-mod
```

Then import your code using:
```ts 
import makeWASocket from '@alexainc/baileys-mod'
```
...
```ts
import makeWASocket, { useMultiFileAuthState } from '@alexainc/baileys-mod'
...
```ts
import makeWASocket, { DisconnectReason, useMultiFileAuthState } from '@alexainc/baileys-mod'
...
import { makeInMemoryStore, getAggregateVotesInPollMessage } from '@alexainc/baileys-mod'

const logger = pino({ timestamp: () => `,"time":"${new Date().toJSON()}"` }).child({ class: "@alexainc/baileys-mod" })
logger.level = "fatal"
...
```ts
import { jidNormalizedUser, getAggregateResponsesInEventMessage } from '@alexainc/baileys-mod'
...
```ts
import makeWASocket, { makeInMemoryStore } from '@alexainc/baileys-mod'
...
import { downloadMediaMessage, getContentType } from '@alexainc/baileys-mod'
